...
const About = () =>{
    return (
        ...
        <div id="about-section" className="about-sec">
            ...
            discoloration due to age, give us a call for a consultation! Our technicians are courteous, 
            professional, and reliable. By upholding precision and quality, we've cemented our reputation.<br/>
                <span className="last-words-about">Experience the difference with us – your go-to for all rim repair needs.</span>
            </p>
        </div>
